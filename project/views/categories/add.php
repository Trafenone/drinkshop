...
<h1 class="text-center mt-1">Додавання нової категорії товару</h1>
...
<form id="category" method="post" action="">
    ...
    <div class="mb-3">
        ...
        <input name="name" type="text" class="form-control" id="name" placeholder="Назва категорії" required>
    </div>
